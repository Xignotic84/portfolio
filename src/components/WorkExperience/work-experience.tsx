...
export type ExperienceItemType = {
  ...
  companyLogo?: string;
  /** URL or path to the company's page */
  companyUrl?: string
      ...
      <div className="not-prose flex items-center gap-3">
        ...
        >
          {experience.companyLogo ? (
            ...
            <span className="flex size-2 rounded-md bg-zinc-300 dark:bg-zinc-600"/>
          )}
        </div>
        ...
        <div className={'flex w-full gap-2 items-center'}>
          ...
          {experience.companyUrl && (
            <Button size={'icon'} variant={'ghost'} render={<Link target={'_blank'} href={experience.companyUrl}/>}>
